...
public class Lv2MagnetItem extends Item {
    ...
    public Lv2MagnetItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand){
        ...
        if (!(itemStack.getItem() instanceof Lv2MagnetItem)) return TypedActionResult.pass(itemStack);
