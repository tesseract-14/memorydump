...
import net.fabricmc.memorydmp.items.*;
import net.fabricmc.memorydmp.items.Magnets.Lv1MagnetItem;
import net.fabricmc.memorydmp.items.Magnets.Lv2MagnetItem;
import net.fabricmc.memorydmp.items.Magnets.Lv3MagnetItem;
import net.fabricmc.memorydmp.items.OrbitalTNTCannons.StabShot;
...
public class MemoryDmpMod implements ModInitializer {
    ...
    public static final Item ENTITY_RIDER = new EntityRiderItem(new Item.Settings().maxCount(1));
    public static final Item BLOCKPOINT = new BlockPointItem(new Item.Settings().maxCount(1));
    public static final Item BLANK = new RedactedItem(new Item.Settings().maxCount(1));
    public static final Item WEATHER = new WeatherItem(new Item.Settings().maxCount(1));

    public static final Item LV1_MAGNET = new Lv1MagnetItem(new Item.Settings().maxCount(1));
    public static final Item LV2_MAGNET = new Lv2MagnetItem(new Item.Settings().maxCount(1));
    public static final Item LV3_MAGNET = new Lv3MagnetItem(new Item.Settings().maxCount(1));

    public static final Item STABSHOT = new StabShot(new Item.Settings().maxCount(1));
    // ====================================== Random turner block =========================
...
//    public static EntityType<StabShotBobberEntity> STABSHOT_BOBBER;
...
//        reg entities
//        STABSHOT_BOBBER = FabricEntityTypeBuilder.create(
//                        SpawnGroup.MISC,
//                        (type, world) -> new StabShotBobberEntity(type, world) // adjust constructor
//                ).dimensions(EntityDimensions.fixed(0.25f, 0.25f))
//                .build();
...
//                stacks.add(new ItemStack(MEMORYLEAK));
                stacks.add(new ItemStack(ENTITY_RIDER));
                stacks.add(new ItemStack(BLOCKPOINT));
                stacks.add(new ItemStack(BLANK));
                stacks.add(new ItemStack(WEATHER));

                stacks.add(new ItemStack(LV1_MAGNET));
                stacks.add(new ItemStack(LV2_MAGNET));
                stacks.add(new ItemStack(LV3_MAGNET));

//                stacks.add(new ItemStack(STABSHOT));
            })
            .build();
        ...
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "entity_rider"), ENTITY_RIDER);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "blockpoint"), BLOCKPOINT);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "blank"), BLANK);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "weather_ctrl"), WEATHER);

        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "magnet_lv1"), LV1_MAGNET);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "magnet_lv2"), LV2_MAGNET);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "magnet_lv3"), LV3_MAGNET);

        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "stabshot"), STABSHOT);
